...
public class ElementNotFoundAdvice {
	...
	/**
	 * This function will be called whenever an {@link ElementNotFoundException} is
	 * thrown. It will return a 404
	 * status code and a plain text message with the exception message.
	 * 
	 * @param exception The exception that was thrown.
	 * @return A {@link ResponseEntity} with a status of 404, a content type of
